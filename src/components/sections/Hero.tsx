...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-white">
      ...
      />
      <div
        className={`absolute bottom-1/4 ${isRtl ? "left-1/4" : "right-1/4"} -z-10 w-96 h-96 bg-primary/10 rounded-full blur-[120px]`}
      />
        ...
        >
          ...
          <div className="relative z-10 bg-white/40 backdrop-blur-xl rounded-[40px] border border-white/60 shadow-2xl p-8 overflow-hidden group">
            <div className="aspect-[4/3] bg-gradient-to-br from-primary/5 to-primary/20 rounded-3xl flex items-center justify-center p-12">
              ...
              >
                <div
                  className={`bg-white rounded-2xl shadow-2xl p-6 border border-gray-100 ${isRtl ? "rotate-[10deg]" : "rotate-[-10deg]"} transform transition-transform group-hover:rotate-0 duration-500`}
                >
                  ...
                  <div className="flex items-end justify-between">
                    <div>
                      <div className="text-[10px] text-gray-400 font-medium mb-1 uppercase">
                        {t("balance")}
                      </div>
                ...
                {/* Floating Elements */}
                <div
                  className={`absolute -top-4 ${isRtl ? "-left-10" : "-right-10"} bg-white p-4 rounded-2xl shadow-xl border border-gray-100 flex items-center gap-3 ${isRtl ? "rotate-[-15deg]" : "rotate-[15deg]"} group-hover:rotate-0 duration-500`}
                >
